...
const Header = () => {
  ...
  const unActive="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
  return (
    <header>
          ...
          <div className="flex md:order-2">
            ...
            <div className={`${Hidden ? "hidden":""}  items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-search`}>
              ...
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                {/* isActive object to change the active status of menu */}
                <li>
                  <NavLink to="/" className={({isActive})=>isActive?Active:unActive} end>Home</NavLink>
                </li>
                <li>
                  <NavLink to="/popular" className={({isActive})=>isActive?Active:unActive}>Popular</NavLink>
                </li>
                <li>
                  <NavLink to="/top-rated" className={({isActive})=>isActive?Active:unActive}>Top Rated</NavLink>
                </li>
                <li>
                  <NavLink to="/upcoming" className={({isActive})=>isActive?Active:unActive}>Upcoming</NavLink>
                </li>
              </ul>
            </div>
          </div>
